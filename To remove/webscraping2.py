...
def data_extract(links_file):
    ...
    with open('house.csv', 'a+', newline='') as csvfile: # hcange w to a to overwrite
        ...
        for link in links_list:
            ...
            #page = requests.get('https://www.habitaclia.com/comprar-piso-de_diseno_junto_a_paseo_sant_joan_dreta_de_l_eixample-barcelona-i3741004269009.htm?pag=1&f=&geo=p&from=list&lo=55') # page es l'objecte on es guarda el get
